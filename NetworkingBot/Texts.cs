...
public static class Texts
{
    ...
    public class MatchMessageType
    {
        ...
        {
            return
                $"Ура 🎉 Мы нашли собеседника. Напиши этому пользователю {user.ToHtmlLink()} - не стесняйся писать первым и предлагать удобную локацию для встречи. Это может быть зона кофебрейков, для ориентира какой-то стенд, или же можно встретиться на улице около площадки - решать вам ☀️\n\nКогда встреча состоится, пожалуйста, нажми на кнопку {meetingHappenCommand.Text.Bold().Quoted()} - хочу обезличено посчитать, сколько новых знакомств я помог совершить на конференции 😊\n\nЕсли встреча не состоялась - нажми {meetingCanceledCommand.Text.Bold().Quoted()} - в этом случае я сразу же начну искать нового собеседника 👌. Если ник собеседника не выделяется - значит у него включены настройки приватности. Но это не беда - напиши прямо сюда и он увидит твое сообщение в своем чате с ботом";
        }
